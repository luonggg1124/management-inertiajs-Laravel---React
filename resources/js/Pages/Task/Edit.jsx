...
export default function Edit({auth, project, error}) {
            ...
            <form onSubmit={onSubmit} action="" className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
              ...
              <div className="mt-4">
                {project.image_path && (<div>
                  <img src={project.image_path} className="w-64 my-2 rounded"/>
                </div>)}
                <InputLabel htmlFor="project_image_path" className="rounded bg-gray-900 w-28 h-10 flex justify-center items-center" value="Change Image"/>
                <TextInput id="project_image_path" accept="image/*" className="w-0 opacity-0" type="file"
                           name="image"
